...
#library(e1071)
#library(ggplot2)
#  mydb = dbConnect(MariaDB(), user='iotuser',password='iot12345',dbname='iot',host='192.168.219.104')
...
#    menuItem("Logout",icon=icon("user"),href = "http://192.168.219.104/iot/pages/logout.php" )
...
tabItem("mydb",
 fluidRow(
     ...
     box(
        ...
        selectInput("dt_server_ip","Server IP", choices = c("192.168.219.104")),
...
tabItem("mysql",
        ...
        selectInput("server_ip","Server IP", choices = c("192.168.219.104")),
...
tabItem("machinelearnings",
        ...
        title = "MySQL Server Information", background = "black",width=4,
        selectInput("ml_server_ip","Server IP", choices = c("192.168.219.104")),
...
header <- dashboardHeader(
  title = "Aqara AIoT Web Visualization Panel" ,
  titleWidth = 500
...
server <- function(input, output) {
  ...
  getPage <-function(){
return(tags$iframe(src = "http://192.168.219.104/arianalytics/thl_gauges.php"
 ...
 getPage1 <- function(){
 return(tags$iframe(src = "http://192.168.219.104/web/json/livethl.php"
 			, style="width:100%;", frameborder = "0"
			, id = "iframe"
			, height = "1000px"))
 }
 ...
 return(tags$iframe(src = "http://192.168.219.104/arianalytics/RGraph/demos/rgraph-ajax-temp.php"
                        , style="width:100%;", frameborder = "0"
                        , id = "iframe"
                        , height = "1000px"))
 }
...
getPageplotlyr <- function(){
 return(tags$iframe(src = "http://192.168.219.104/plotly/plotly.php"
                        , style="width:100%;", frameborder = "0"
                        , id = "iframe"
                        , height = "500px"))
 }
 ...
 getPagehum <- function(){
 return(tags$iframe(src = "http://192.168.219.104/arianalytics/RGraph/demos/rgraph-ajax-hum.php"
                        , style="width:100%;", frameborder = "0"
                        , id = "iframe"
                        , height = "1000px"))
 }
...
getPageau <- function(){
return(tags$iframe(src= "http://192.168.219.104/iot/pages/add.php"
                        , style="width:100%;", frameboarder = "0"
                        , id = "iframe"
                        , height = "1000px"))
}
...
getPage3 <- function(){
return(tags$iframe(src= "http://192.168.219.104:8000/password"
                        , style="width:100%;", frameboarder = "0"
                        , id = "iframe"
                        , height = "1000px"))
}
...
return(tags$iframe(src= "http://192.168.219.104/arianalytics/RGraph/demos/rgraph-ajax-temp-line.php"
                        , style="width:100%;", frameboarder = "0"
                        , id = "iframe"
                        , height = "400px"))
}
...
return(tags$iframe(src= "http://192.168.219.104/arianalytics/RGraph/demos/rgraph-ajax-hum-line.php"
                        , style="width:100%;", frameboarder = "0"
                        , id = "iframe"
                        , height = "400px"))
}
...
return(tags$iframe(src= "http://192.168.219.104/arianalytics/RGraph/demos/rgraph-ajax-light-line.php"
                        , style="width:100%;", frameboarder = "0"
                        , id = "iframe"
                        , height = "400px"))
}
...
getPage4 <- function(){
return(tags$iframe(src= "http://192.168.219.104/web/json/mp.php"
                        , style="width:100%;", frameboarder = "0"
                        , id = "iframe"
                        , height = "500px"))
}
